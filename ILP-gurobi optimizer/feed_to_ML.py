...
##			        outfile.write(line1 + "\n" + line2 + "\n")
P1 = open('mcf-1G-gem5-power', 'r')
P2 = open('mcf-1.6G-gem5-power', 'r')
P3 = open('mcf-2G-gem5-power','r')
D1 = open('mcf-1G-gem5-delay','r')
D2 = open('mcf-1.6G-gem5-delay','r')
D3 = open('mcf-2G-gem5-delay','r')
...
linesp1 = [line.strip() for line in open('mcf-1G-gem5-power')]
linesp2 = [line.strip() for line in open('mcf-1.6G-gem5-power')]
linesp3 = [line.strip() for line in open('mcf-2G-gem5-power')]
linesd1 = [line.strip() for line in open('mcf-1G-gem5-delay')]
linesd2 = [line.strip() for line in open('mcf-1.6G-gem5-delay')]
linesd3 = [line.strip() for line in open('mcf-2G-gem5-delay')]
